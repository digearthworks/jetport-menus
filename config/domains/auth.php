...
return [
    ...
    'default_site_owner_password' => env('DEFAULT_OWNER_PASSWORD', '$2y$10$w3lz8ysxcYAwN8TECDdcp.6.QHPsmTNkOSajMOyFIv3xprID94Lre'),

    'default_auditor_name' => env('DEFAULT_AUDITOR_NAME', 'Auditor'),
    'default_auditor_email' => env('DEFAULT_AUDITOR_EMAIL', 'auditor@admin.com'),
    'default_auditor_password' => env('DEFAULT_AUDITOR_PASSWORD', '$2y$10$w3lz8ysxcYAwN8TECDdcp.6.QHPsmTNkOSajMOyFIv3xprID94Lre'),

    'default_officer_name' => env('DEFAULT_OFFICER_NAME', 'Client'),
    'default_officer_email' => env('DEFAULT_OFFICER_EMAIL', 'client@example.com'),
    'default_officer_password' => env('DEFAULT_OFFICER_PASSWORD', '$2y$10$w3lz8ysxcYAwN8TECDdcp.6.QHPsmTNkOSajMOyFIv3xprID94Lre'),
    ...
    'default_supervisor_password' => env('DEFAULT_SUPERVISOR_PASSWORD', '$2y$10$w3lz8ysxcYAwN8TECDdcp.6.QHPsmTNkOSajMOyFIv3xprID94Lre'),
];
